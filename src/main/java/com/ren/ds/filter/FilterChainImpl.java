...
import com.ren.ds.pool.proxy.CallableStatementProxy;
import com.ren.ds.pool.proxy.CallableStatementProxyImpl;
import com.ren.ds.pool.proxy.ConnectionProxy;
import com.ren.ds.pool.proxy.ConnectionProxyImpl;
import com.ren.ds.pool.proxy.DataSourceProxy;
import com.ren.ds.pool.proxy.PreparedStatementProxy;
import com.ren.ds.pool.proxy.PreparedStatementProxyImpl;
import com.ren.ds.pool.proxy.ResultSetMetaDataProxy;
import com.ren.ds.pool.proxy.ResultSetMetaDataProxyImpl;
import com.ren.ds.pool.proxy.ResultSetProxy;
import com.ren.ds.pool.proxy.ResultSetProxyImpl;
import com.ren.ds.pool.proxy.StatementProxy;
import com.ren.ds.pool.proxy.StatementProxyImpl;
/**
 * 过滤链实现，可以方便的将filter插入到任何地方；
 * 由于对于clob和类似的clob方法并没有再filter和filterChain中，忽视这个的代理
 * @author REN
 *
 */
public class FilterChainImpl implements FilterChain {
    ...
    public NClob connection_createNClob(ConnectionProxy connection) throws SQLException {
        ...
        return connection.getRawObject().createNClob();
...
//        }
    ...
    public Clob resultSet_getClob(ResultSetProxy resultSet, int columnIndex) throws SQLException {
        ...
        return  resultSet.getResultSetRaw().getClob(columnIndex);
...
//        }
    ...
    public Clob resultSet_getClob(ResultSetProxy resultSet, String columnLabel) throws SQLException {
        ...
        return resultSet.getResultSetRaw().getClob(columnLabel);
...
//        }
    ...
    public Clob callableStatement_getClob(CallableStatementProxy statement, int parameterIndex) throws SQLException {
        ...
        return statement.getRawObject().getClob(parameterIndex);
    ...
    public Clob callableStatement_getClob(CallableStatementProxy statement, String parameterName) throws SQLException {
        ...
        return statement.getRawObject().getClob(parameterName);
    ...
    public NClob callableStatement_getNClob(CallableStatementProxy statement, int parameterIndex) throws SQLException {
        ...
        return statement.getRawObject().getNClob(parameterIndex);
    ...
    public NClob callableStatement_getNClob(CallableStatementProxy statement, String parameterName) throws SQLException {
        ...
        return statement.getRawObject().getNClob(parameterName);
...
//    }
    ...
    @Override
    public void dataSource_recycle(PooledConnection connection) throws SQLException {
        if (this.pos < filterSize) {
    ...
    /**
     * 将会代理dataSource的getConnection方法
     */
    @Override
    public PooledConnection dataSource_connect(DataSource dataSource, long maxWaitMillis) throws SQLException {
        if (this.pos < filterSize) {
            PooledConnection conn = nextFilter().dataSource_getConnection(this, dataSource, maxWaitMillis);
            return conn;
        }
