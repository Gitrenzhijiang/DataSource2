...
//    void clob_truncate(ClobProxy wrapper, long len) throws SQLException;
    ...
    void dataSource_recycle(PooledConnection connection) throws SQLException;

    PooledConnection dataSource_connect(DataSource dataSource, long maxWaitMillis) throws SQLException;
