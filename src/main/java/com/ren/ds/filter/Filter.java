...
//    void clob_truncate(FilterChain chain, ClobProxy wrapper, long len) throws SQLException;
    ...
    void dataSource_releaseConnection(FilterChain chain, PooledConnection connection) throws SQLException;

    PooledConnection dataSource_getConnection(FilterChain chain, DataSource dataSource, long maxWaitMillis)
                                                                                                                     throws SQLException;
